      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-3">
          ...
          <NuxtLink to="/teacher/subjects" 
            class="block w-full text-left px-4 py-2 bg-purple-50 text-purple-700 rounded-md hover:bg-purple-100 transition-colors">
            My subjects ({{ stats?.subjects?.length || 0 }})
          </NuxtLink>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-3">
          <NuxtLink to="/teacher/reviews" 
            ...
            My opinions ({{ stats?.overview?.totalReviews || 0 }})
          </NuxtLink>
      ...
      <div class="bg-white rounded-lg shadow">
        ...
        <div class="p-6">
              ...
              <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                  <span class="text-sm text-gray-500">
                    {{ getSubjectBookingCount(subject._id) }} reservations
                  </span>
                </div>
              </div>
            </div>
          ...
          <div v-else class="text-center py-8 text-gray-500">
            ...
            <p class="text-sm text-gray-400 mt-1">Contact the administration to add subjects</p>
          </div>
        </div>
      </div>
    </div>
